...
def extract_data(stage_on, stage_off):
    np_wave = np.loadtxt('E:/raw_data/15', encoding='utf-8', delimiter=';', skiprows=1, usecols=4)
    df_anno = pd.read_csv('E:/raw_data/15_a.txt', encoding='ansi')
...
x_data, y_data = extract_data(1, 114)
with open('E:/data/data_14', 'w') as fx:
